...
const EDHero = () => {
  ...
  return (
    ...
    >
      {/* Background image - rendered as a real <img> with object-fit: cover
          instead of a CSS background-image, so it fills the section
          edge-to-edge without being over-scaled or cropped oddly. Image URL
          is unchanged. */}
      <Box
        style={{
          position: "absolute",
      ...
      >
        <img
          src="https://www.csipl.net/img/ecommerce_banner01.jpg"
          alt=""
          style={{
            width: "100%",
            height: "100%",
      ...
      <Container size="lg" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <Stack gap={24}>
            ...
            >
              We develop eCommerce websites that combine intuitive user
              journeys, reliable functionality, and modern design to
              deliver engaging shopping experiences and support the
              evolving needs of your online business.
            </Text>
