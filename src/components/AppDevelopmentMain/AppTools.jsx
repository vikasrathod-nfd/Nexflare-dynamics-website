...
// seen elsewhere. Exact brand logos where Tabler has them (React, Swift,
// Kotlin, Node.js), and close-fit generic icons tinted with the brand's
// official color for tools without a native Tabler logo (Flutter,
// Firebase, AWS Amplify, GraphQL, REST, Figma, Xcode, Android Studio).
const TOOLS = [
  { name: "React Native", Icon: IconBrandReact, color: "#61DAFB" },
  { name: "Flutter", Icon: IconFeather, color: "#02569B" },
  { name: "Swift / SwiftUI", Icon: IconBrandSwift, color: "#F05138" },
  { name: "Kotlin", Icon: IconBrandKotlin, color: "#7F52FF" },
  { name: "Node.js", Icon: IconBrandNodejs, color: "#5FA04E" },
  { name: "Firebase", Icon: IconFlame, color: "#FFCA28" },
  { name: "AWS Amplify", Icon: IconCloud, color: "#FF9900" },
  { name: "GraphQL", Icon: IconApi, color: "#E10098" },
  { name: "REST APIs", Icon: IconPlugConnected, color: "#14b8a6" },
    ...
    >
      ...
      <Container size="xl" style={{ position: "relative", zIndex: 1 }}>
        <Stack gap={6} maw={720} mb={48}>
          ...
          >
            We build digital solutions using industry-proven technologies and modern architectures that support scalability, security, and operational excellence. Our technology-driven approach ensures every application delivers consistent performance and adapts to future business needs.
          </Text>
        </Stack>
