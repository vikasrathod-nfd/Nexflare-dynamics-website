...
const WhatsAppChatWidget = () => {
  ...
  const handleSendMessage = (e) => {
    ...
    // Message encode karun WhatsApp URL tayar karne
    ...
    <div className="whatsapp-widget-container">
      ...
      {isOpen && (
        <div className="whatsapp-chat-box">
          ...
          <form onSubmit={handleSendMessage} className="whatsapp-chat-footer">
            <input
              type="text"
      ...
      <button className="whatsapp-floating-icon" onClick={toggleChat}>
        {isOpen ? (
