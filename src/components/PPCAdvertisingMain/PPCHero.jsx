    ...
    >
      ...
      <Box
        style={{
          ...
          inset: 0,
          backgroundImage:
            "url('https://resultsrepeat.com/wp-content/uploads/2019/10/ppc-featured-image.png')",
      ...
      <Container size="xl" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <Stack gap={30}>
            ...
            >
              Accelerate your business growth with strategic Pay Per Click
              advertising designed to deliver measurable results. We create,
              manage, and continuously optimize high-performing campaigns
              helping you generate qualified leads, increase conversions,
              and maximize return on every advertising investment.
            </Text>
            <Group mt={10}>
              <Button
                size="lg"
