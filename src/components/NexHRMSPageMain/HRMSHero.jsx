...
const HRMSHero = () => {
  ...
  const handleRequestDemo = () => {
    navigate("/contact"); // Change if your contact route is different
  };
          ...
          <Stack gap={30}>
            ...
            >
              ...
              <Text
                ...
                inherit
                variant="gradient"
                gradient={{ from: "#818cf8", to: "#14b8a6" }}
              >
                HRMS
              </Text>
            </Title>
            ...
            >
              A complete Human Resource Management System that brings
              employee records, attendance, leave, and payroll together in
              one modern platform built to remove manual work from
              everyday HR operations and give leadership real-time
              visibility.
            </Text>
            <Group mt={10}>
              <Button
