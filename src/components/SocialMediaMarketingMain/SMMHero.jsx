    ...
    >
      ...
      <Box
        style={{
          ...
          inset: 0,
          backgroundImage:
            "url('https://media.istockphoto.com/id/1346575545/photo/3d-render-of-social-media-business-concept.jpg?s=612x612&w=0&k=20&c=1083IFHVsot9K6aguY59kOLCWIijhPQT69oYJB9SYS0=')",
      ...
      <Container size="xl" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <Stack gap={30}>
            ...
            >
              Transform your social media into a powerful business growth
              engine. We create impactful content, execute targeted
              campaigns, foster meaningful audience interactions, and
              continuously optimize performance to enhance brand awareness,
              generate qualified leads, and support sustainable business
              growth.
            </Text>
            <Group mt={10}>
              <Button
