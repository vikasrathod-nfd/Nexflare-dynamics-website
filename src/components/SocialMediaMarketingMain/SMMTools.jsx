...
import { SiMeta, SiHootsuite, SiBuffer, SiYoutube } from "react-icons/si";
import {
  IconCalendarEvent,
  IconChartHistogram,
  IconRadar,
...
// Canva, Adobe Premiere, Sprout Social, Later, BuzzSumo, and Brandwatch don't
// have a Simple Icons entry, so those use a close-fit Tabler icon instead,
// each tinted with that brand's actual color so it still reads as
...
const tools = [
  ...
  { name: "Adobe Premiere", Icon: IconMovie, color: "#9999FF" },
  ...
  { name: "BuzzSumo", Icon: IconChartHistogram, color: "#EF4444" },
