...
const steps = [
  {
    ...
    description:
      "We analyze your business needs, define API endpoints, data structures, authentication flows, and create a clear architecture plan to ensure a scalable and efficient API foundation.",
  ...
  },
  {
    ...
    description:
      "Our team develops secure and high-performing APIs with proper validation, authentication, error handling, and optimization to ensure reliability and smooth application performance.",
    icon: IconShieldLock,
  },
  {
    number: "03",
    ...
    description:
      "Every API goes through detailed testing for functionality, performance, and security. We provide complete documentation with clear guidelines for easy integration and future maintenance.",
    icon: IconChecklist,
  },
  {
    number: "04",
    ...
    description:
      "We deploy APIs with proper monitoring, error tracking, and version control to maintain stability, ensure uptime, and support future updates without affecting existing systems.",
    icon: IconRocket,
  },
];
