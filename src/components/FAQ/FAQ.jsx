...
const faqs = [
  {
    ...
    question: "What industries do you specialize in for IT solutions?",
    answer:
      "We provide tailored IT solutions for a wide range of industries, including Healthcare, Finance, Retail, E-commerce, Manufacturing, Education, Logistics, Real Estate, Hospitality, and Professional Services. Our team develops industry-specific software, cloud, and digital marketing solutions that address unique business challenges and support long-term growth.",
  },
  {
    cat: "process",
    question: "How do you ensure security of the applications you provide?",
    answer:
      "Security is integrated into every stage of our development process. We follow secure coding standards, implement data encryption, role-based access control, multi-factor authentication, regular vulnerability assessments, and industry best practices to deliver secure, reliable, and compliant applications.",
  },
  {
    cat: "process",
    question: "Can you handle large-scale enterprise cloud migrations?",
    answer:
      "Yes. We plan and execute secure cloud migration projects for businesses of all sizes. Our process includes infrastructure assessment, migration strategy, application modernization, data transfer, testing, performance optimization, and post-migration support to ensure minimal downtime and business continuity.",
  },
  {
    cat: "process",
    question: "Do you offer post-launch support and maintenance?",
    answer:
      "Absolutely. We provide ongoing maintenance and support services, including performance monitoring, security updates, bug fixes, feature enhancements, cloud optimization, backups, and technical assistance to ensure your applications remain secure, reliable, and up to date.",
  },
  {
    cat: "services",
    question: "What sets your cloud solutions apart from competitors?",
    answer:
      "Our cloud solutions are designed for scalability, security, and cost efficiency. We leverage modern cloud platforms, DevOps practices, containerization, and automation to build highly available infrastructures that improve performance, simplify management, and support future business growth.",
  },
  {
    cat: "legal",
    question: "Can you handle end-to-end IT product development?",
    answer:
      "Yes. We offer complete product development services, from business analysis, UI/UX design, software development, cloud deployment, and quality assurance to ongoing maintenance and digital marketing support. Our end-to-end approach ensures a seamless development experience and successful product delivery.",
  },
  {
    cat: "mobile",
    question: "Do you build for both iOS and Android?",
    answer:
      "Yes. We develop high-quality mobile applications for both iOS and Android using cross-platform technologies like React Native and Flutter, as well as native development when required. We also assist with testing, deployment, and App Store and Google Play Store publishing.",
  },
  {
    cat: "cloud",
    question: "Which technologies and cloud platforms do you use?",
    answer:
      "Our technology stack includes React, Next.js, Angular, Vue.js, Java, Spring Boot, .NET, Python, Node.js, Express.js, PHP, Laravel, Flutter, React Native, MySQL, PostgreSQL, SQL Server, MongoDB, Docker, Kubernetes, AWS, Microsoft Azure, Google Cloud Platform (GCP), DigitalOcean, Power BI, REST APIs, Microservices, and modern DevOps tools.",
  },
  {
    cat: "process",
    question: "How do we get started?",
    answer:
      "Getting started is simple. Contact us through our website, schedule a consultation, or request a free quote. We'll discuss your business goals, understand your requirements, recommend the best solution, and provide a detailed project proposal with timelines, scope, and pricing before development begins.",
  },
];
        ...
        >
          <Box style={{ overflow: "hidden", minHeight: 0 }}>
            <Box
              ...
              pt={0}
              style={{
                borderTop: `1px solid ${isDark ? "rgba(255,255,255,0.06)" : "rgba(37,99,235,0.08)"
                  }`,
                paddingTop: 18,
                marginLeft: 0,
                opacity: open ? 1 : 0,
                ...
                <Paper
                  ...
                  style={{
                    background: isDark
                      ? "linear-gradient(145deg,rgba(37,99,235,0.18),rgba(14,165,233,0.12))"
                      : "linear-gradient(145deg,#EFF6FF,#E0F2FE)",
                    border: `1.5px solid ${isDark ? "rgba(37,99,235,0.35)" : "rgba(37,99,235,0.18)"
                      }`,
                  }}
                >
                  <ThemeIcon
                  ...
                  {[
                    {
                      ...
                      sub: (
                        <>
                          <Text size="sm">enquiry@nexflaredynamics.com</Text>
                          <Text size="sm">contact-us@nexflaredynamics.com</Text>
                        </>
                      ),
                      color: "blue",
                    },
                    {
                      ...
                      sub: (
                        <>
                          <Text size="sm">+91 8237525097</Text>
                          <Text size="sm">+91 9834496938</Text>
                        </>
                      ),
                      color: "green",
                    },
