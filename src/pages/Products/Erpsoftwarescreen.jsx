...
/* ── static data ───────────────────────────────────── */
const features = [
  { icon: IconBuildingFactory2, title: "Production Planning & BOM",   desc: "Bill of Materials and work order management for manufacturing floors", color: "#6366F1" },
  { icon: IconPackage,          title: "Inventory & Warehouse",        desc: "Real-time stock tracking, warehouse management, and demand forecasting", color: "#F59E0B" },
  { icon: IconReceiptTax,       title: "GST-Compliant Finance",        desc: "E-Invoicing, ITC-04, and full GST compliance built-in for Indian businesses", color: "#10B981" },
  { icon: IconTruckDelivery,    title: "Supply Chain & Procurement",   desc: "End-to-end vendor management and procurement automation", color: "#EC4899" },
];
