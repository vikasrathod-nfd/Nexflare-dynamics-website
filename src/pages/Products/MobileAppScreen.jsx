...
const features = [
  { icon: IconDeviceMobile,  title: "Cross-Platform Builds",     desc: "Single codebase for both Android and iOS using React Native", color: "#6366F1" },
  { icon: IconLayoutGrid,    title: "UI/UX Design",              desc: "Pixel-perfect interfaces that users love from the very first tap", color: "#F59E0B" },
  { icon: IconBellRinging,   title: "Push Notifications",        desc: "Real-time alerts and smart notifications to keep users engaged", color: "#10B981" },
  { icon: IconShieldLock,    title: "Offline Mode & Security",   desc: "Works without internet; encrypted data storage and secure APIs", color: "#EC4899" },
];

const bullets = [
  "End-to-end mobile app development, from concept to launch",
  "Native & cross-platform solutions for Android and iOS",
];
            ...
            >
              <Stack gap={20}>
                ...
                <Text size="sm" lh={1.85} style={{ color:textSub, maxWidth:480 }}>
                  Transform ideas into high-performance mobile applications designed
                  for seamless user experiences. From concept and design to development
                  and deployment, we deliver scalable, secure, and feature-rich solutions
                  with cross-platform compatibility, real-time notifications, and reliable performance.
                </Text>
            ...
            >
              <Box style={{
                ...
                <Box style={{
                  ...
                  <img
                    src={HERO_IMAGE_URL}
                    alt="Indian user happily using a mobile app"
                    style={{
                  ...
                  <Box style={{
                    ...
                    <Stack gap={2}>
                      <Text fw={800} size="lg" c="white">Mobile Apps</Text>
                      <Text size="xs" c="rgba(255,255,255,0.75)">Built for users across India</Text>
                    </Stack>
                    <Badge
                      size="md"
                      style={{
