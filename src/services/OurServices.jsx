...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "We design and build robust, scalable mobile and web applications tailored to your business needs. From native iOS and Android apps to cross-platform solutions, we ensure seamless performance, intuitive UX, and long-term support.",
  },
  {
...
const CSS = `
  ...
  /* Attractive Background Pattern & Image Overlay for Cards */
  .svc-card::before {
    content: "";
    position: absolute;
    top: 0;
  ...
  /* Ensure card contents stay above the background layer */
  .svc-card > * {
    position: relative;
    z-index: 1;
  }
...
const THEME_VARS = {
  dark: {
    ...
    "--orange": "#f0a860",
    "--green": "#4fd18b",
    "--card-bg": "rgba(13, 23, 48, 0.75)",
    "--icon-bg": "rgba(255,255,255,0.06)",
    "--notice-bg": "rgba(6,182,212,0.08)",
    "--toggle-bg": "rgba(255,255,255,0.05)",
    /* Modern geometric/tech SVG background overlay for dark mode cards */
    "--card-pattern": "radial-gradient(circle at 90% 10%, rgba(59, 157, 255, 0.12) 0%, transparent 60%), linear-gradient(135deg, rgba(30, 43, 69, 0.4) 0%, rgba(13, 23, 48, 0.8) 100%)",
    background: `
  ...
  light: {
    ...
    "--icon-bg": "rgba(37, 99, 235, 0.06)",
    "--notice-bg": "rgba(6,182,212,0.07)",
    "--toggle-bg": "#ffffff",
    /* Modern light mode gradient/pattern backdrop for cards */
    "--card-pattern": "radial-gradient(circle at 90% 10%, rgba(37, 99, 235, 0.07) 0%, transparent 60%), linear-gradient(135deg, rgba(255, 255, 255, 0.9) 0%, rgba(240, 247, 255, 0.7) 100%)",
    background: `
